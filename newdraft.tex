...
\end{align}
\brian{Should we call this the  ``generalized para B twist"? It is invariant with respect to the anti-diagonal twisting homomorphism $SO(1,1) \to SO(1,1) \times SO(1,1)$. I think Kapustin-Li call this the axial.}
