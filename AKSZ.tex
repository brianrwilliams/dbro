...
One way to do this is to assume that the para-complex manifold $M$ is equipped with a para-holomorphic volume form $\Omega_X$. \brian{Cite David's new section.}
\end{Ex}
...
\brian{Recall that a generalized para-complex structure $\KK$ defines a Dirac structure in $\TT$, and hence a Lagrangian inside of the $2$-shifted symplectic space $\XX_H$.  
...
The classical observables are equivalent to para-holomorphic polyvector fields on $X$.
